...
import { Cog6ToothIcon, EyeSlashIcon, MagnifyingGlassIcon } from "@heroicons/react/24/outline";
                    ...
                    <div className="flex justify-between flex-col">
                      ...
                      <div className="font-medium text-base flex flex-col">
                        ...
                        <div className="font-semibold">
                          ...
                          <span className="text-sm text-slate-400">({data?.expand?.buyer?.studentId})</span>
                        </div>
                        <div className="mx-1">-</div>
                        <div className="font-semibold">
                          {data?.expand?.seller?.name}
                          <span className="text-sm text-slate-400">({data?.expand?.seller?.studentId})</span>
                        </div>
                        </div>
