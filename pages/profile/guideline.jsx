  ...
  return (
    <AutonomyPage>
        <Layout>
            ...
            <Block>
                <Paragraph>
                안녕하세요. &apos;드려유&apos;의 기능과 이용 규칙을 안내하는 페이지입니다.
                원활한 서비스 이용을 위해 <span className="font-bold">반드시 정독</span> 부탁드려요!
                </Paragraph>
            </Block>
            <Block>
                ...
                <Paragraph>
                    ...
                    와 <span className="text-amber-500">자율위원단</span>이 개발 및 운영하며,
                    한시적으로 운영되는 이벤트성 플랫폼입니다. 운영 기간은 7.11(화) ~ 7.14(금)이에요.
                </Paragraph>
            </Block>
            <Block>
                ...
                <Paragraph>
                    ...
                    풀지 않을 거지만 버리긴 아까운 문제집이 있나요? 드려유에서
                    내가 가진 물건이 필요한 사람을 쉽게 찾고 물건을 나눔할 수 있어요.
                    플러스(+) 아이콘을 눌러 물건 정보를 올리면 자율위원의 
                    승인을 거쳐 물건이 등록됩니다.

                    <Subtitle>2. 물건 찾기</Subtitle>
                    메인 페이지에는 다른 사람들이 올린 물건들이 보여요. 사진, 설명 등 정보를 확인하고
                    물건을 나눔받길 원한다면 채팅 기능으로 물건을 올린 사람에게 문의가 가능합니다.
                    
                    <Subtitle>3. 채팅</Subtitle>
                    채팅 기능을 통해 물건의 상태를 확인하거나 물건을 전달할 시간, 장소를 조율할 수 있어요.

                    <Subtitle>4. 나눔 완료 & 후기 작성</Subtitle>
                    물건을 전달한 뒤, 등록한 사람이 &apos;나눔 완료&apos; 버튼을 누르면 더 이상
                    문의할 수 없게 되고, 준 사람과 받은 사람 둘 다 후기를 작성할 수 있어요.
                    후기를 작성하면 &apos;품격 온도&apos;가 오르는데, 운영 기간이 끝난 후
                    품격 온도가 높은 학생들에게 소정의 상품을 지급할 예정입니다.
                </Paragraph>
            </Block>
            <Block>
                <Title>물건 등록 시 주의사항</Title>
                <Paragraph>
                    <Subtitle>1. 물건을 올리는 즉시 메인 페이지에서 보이지는 않아요.</Subtitle>
                    부적절한 물건의 등록을 방지하기 위해, 모든 물건은 자율위원의 검토를 거친 뒤 등록됩니다.
                    다만 아직 검토되지 않은 물건도 프로필 → &apos;내가 등록한 물건&apos; 페이지에서
                    확인하거나 수정할 수 있어요.
                    <Subtitle>2. 물건 사진, 제목, 설명을 통해 물건의 종류와 상태를 알아볼 수 있도록 해 주세요.</Subtitle>
                    <Subtitle>3. 금전이 오가는 거래는 불가합니다.</Subtitle>
                    물건 나눔(혹은 물물교환)의 용도로만 서비스를 이용해 주세요.
                    <Subtitle>4. 학교에서 거래하기 부적절한 물건은 등록을 지양해 주세요.</Subtitle>
            ...
            <Block>
                <Paragraph>
                    읽어 주셔서 감사합니다! 프로필 → &apos;도움말&apos; 버튼을
                    눌러 언제든 이 페이지로 돌아올 수 있습니다. 더 궁금한 점이 있다면
                    드려유 고객센터를 이용해 주세요.
                </Paragraph>
            </Block>
        </Layout>
