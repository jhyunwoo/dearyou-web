  ...
  return (
    <div className="w-full min-h-screen bg-slate-50 p-4 flex justify-center items-center">
      ...
      <div className="bg-white max-w-xl shadow-xl p-8 py-16 flex flex-col w-5/6 space-y-2">
        ...
        {/* <button
          onClick={googleLogin}
          className="bg-white shadow-lg p-2 px-4 rounded-lg flex hover:bg-slate-100 transition duration-200"
        >
          <div className="font-semibold text-base m-auto text-black">
            구글로 로그인
          </div>
        </button> */}
      </div>
